...
function buildPrefsWidget() {
    ...
    function find(container, names, level = 0) {
        let target = null;
        container.forall((child, data) => {
            if (child instanceof Gtk.Container) { // TODO - check this addition
...
module.exports = { init, buildPrefsWidget };