...
export function atomic_rc_box_release_full(mem_block: any, clear_func: DestroyNotify): void;
...
export function hash_table_add(hash_table: HashTable, key: any | null): boolean;

export function hash_table_contains(hash_table: HashTable, key: any | null): boolean;

export function hash_table_destroy(hash_table: HashTable): void;

export function hash_table_insert(hash_table: HashTable, key: any | null, value: any | null): boolean;

export function hash_table_lookup(hash_table: HashTable, key: any | null): any | null;

export function hash_table_lookup_extended(hash_table: HashTable, lookup_key: any | null): [boolean, any | null, any | null];

export function hash_table_remove(hash_table: HashTable, key: any | null): boolean;

export function hash_table_remove_all(hash_table: HashTable): void;

export function hash_table_replace(hash_table: HashTable, key: any | null, value: any | null): boolean;

export function hash_table_size(hash_table: HashTable): number;

export function hash_table_steal(hash_table: HashTable, key: any | null): boolean;

export function hash_table_steal_all(hash_table: HashTable): void;

export function hash_table_steal_extended(hash_table: HashTable, lookup_key: any | null): [boolean, any | null, any | null];
...
export function rc_box_release_full(mem_block: any, clear_func: DestroyNotify): void;
...
export function spawn_async(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null): [boolean, Pid | null];

export function spawn_async_with_fds(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null, stdin_fd: number, stdout_fd: number, stderr_fd: number): [boolean, Pid | null];

export function spawn_async_with_pipes(working_directory: string | null, argv: string[], envp: string[] | null, flags: SpawnFlags, child_setup: SpawnChildSetupFunc | null): [boolean, Pid | null, number | null, number | null, number | null];
...
export function test_add_data_func_full(testpath: string, test_data: any | null, test_func: TestDataFunc, data_free_func: DestroyNotify): void;
...
export function test_queue_destroy(destroy_func: DestroyNotify, destroy_data: any | null): void;
...
export function unix_fd_add_full(priority: number, fd: number, condition: IOCondition, _function: UnixFDSourceFunc, notify: DestroyNotify): number;
...
export class HashTable {
    ...
    static lookup_extended(hash_table: HashTable, lookup_key: any | null): [boolean, any | null, any | null];
    ...
    static steal_extended(hash_table: HashTable, lookup_key: any | null): [boolean, any | null, any | null];
...
export class Tree {
    ...
    lookup_extended(lookup_key: any | null, orig_key: any | null, value: any | null): boolean;
    nnodes(): number;
