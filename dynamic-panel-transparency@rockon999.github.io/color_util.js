 ...
 */
function getBackgroundColorInfo(monitorIndex = 0, infoCallback) {
    log('getting info...');
    const cache = imports.ui.background.getBackgroundCache();
    const source = cache.getBackgroundSource(imports.ui.main.layoutManager, imports.ui.background.BACKGROUND_SCHEMA);
...
module.exports = { getBackgroundColorInfo, get_background_color_information };