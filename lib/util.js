...
/* Gnome Versioning */
export const MAJOR_VERSION = Number.parseInt(imports.misc.config.PACKAGE_VERSION.split('.')[0], 10);
export const MINOR_VERSION = Number.parseInt(imports.misc.config.PACKAGE_VERSION.split('.')[1], 10);
