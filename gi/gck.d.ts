...
export function objects_from_handle_array(session: Session, object_handles: number[]): GLib.List;
...
export class Enumerator extends GObject.Object {
    ...
    set_object_type(object_type: GType, attr_types: number[]): void;
}
...
export class Session extends GObject.Object implements Gio.AsyncInitable, Gio.Initable {
    ...
    decrypt(key: Object, mech_type: number, input: (Uint8Array | string), cancellable: Gio.Cancellable | null): Uint8Array;
    decrypt_async(key: Object, mechanism: Mechanism, input: (Uint8Array | string), cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    ...
    encrypt(key: Object, mech_type: number, input: (Uint8Array | string), cancellable: Gio.Cancellable | null): Uint8Array;
    encrypt_async(key: Object, mechanism: Mechanism, input: (Uint8Array | string), cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    ...
    init_pin_async(pin: (Uint8Array | string) | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    init_pin_finish(result: Gio.AsyncResult): boolean;
    login(user_type: number, pin: (Uint8Array | string) | null, cancellable: Gio.Cancellable | null): boolean;
    login_async(user_type: number, pin: (Uint8Array | string) | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    ...
    set_pin_async(old_pin: (Uint8Array | string) | null, n_old_pin: number, new_pin: (Uint8Array | string) | null, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    ...
    sign_async(key: Object, mechanism: Mechanism, input: (Uint8Array | string), cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    sign_finish(result: Gio.AsyncResult): Uint8Array;
    sign_full(key: Object, mechanism: Mechanism, input: (Uint8Array | string), n_result: number, cancellable: Gio.Cancellable | null): number;
    unwrap_key(wrapper: Object, mech_type: number, input: (Uint8Array | string), attrs: Attributes, cancellable: Gio.Cancellable | null): Object;
    unwrap_key_async(wrapper: Object, mechanism: Mechanism, input: (Uint8Array | string), attrs: Attributes, cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
    ...
    verify(key: Object, mech_type: number, input: (Uint8Array | string), signature: (Uint8Array | string), cancellable: Gio.Cancellable | null): boolean;
    verify_async(key: Object, mechanism: Mechanism, input: (Uint8Array | string), signature: (Uint8Array | string), cancellable: Gio.Cancellable | null, callback: Gio.AsyncReadyCallback | null): void;
...
export class Builder {
    ...
    add_data(attr_type: number, value: (Uint8Array | string) | null): void;
    ...
    set_data(attr_type: number, value: (Uint8Array | string) | null): void;
    ...
    steal(): Attributes;
    take_data(attr_type: number, value: (Uint8Array | string) | null): void;
