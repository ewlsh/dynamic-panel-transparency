...
export function utils_same_ssid(ssid1: (Uint8Array | string), ssid2: (Uint8Array | string), ignore_trailing_null: boolean): boolean;

export function utils_security_valid(type: UtilsSecurityType, wifi_caps: DeviceWifiCapabilities, have_ap: boolean, adhoc: boolean, ap_flags: __80211ApFlags, ap_wpa: __80211ApSecurityFlags, ap_rsn: __80211ApSecurityFlags): boolean;
...
export type SecretAgentOldDeleteSecretsFunc = (agent: SecretAgentOld, connection: Connection, error: GLib.Error) => void;

export type SecretAgentOldGetSecretsFunc = (agent: SecretAgentOld, connection: Connection, secrets: GLib.Variant, error: GLib.Error) => void;
...
export type SettingValueIterFn = (setting: Setting, key: string, value: (GObject.Value | string | boolean | number), flags: GObject.ParamFlags) => void;
...
export class DeviceType {
    constructor(copy: DeviceType);
    // Properties
    static UNKNOWN: number;
    static ETHERNET: number;
    static WIFI: number;
    static UNUSED1: number;
    static UNUSED2: number;
    static BT: number;
    static OLPC_MESH: number;
    static WIMAX: number;
    static MODEM: number;
    static INFINIBAND: number;
    static BOND: number;
    static VLAN: number;
    static ADSL: number;
    ...
    static TEAM: number;
    static TUN: number;
    static IP_TUNNEL: number;
    static MACVLAN: number;
    static VXLAN: number;
    static VETH: number;
    static MACSEC: number;
    static DUMMY: number;
    static PPP: number;
    static OVS_INTERFACE: number;
    static OVS_PORT: number;
    static OVS_BRIDGE: number;
    static WPAN: number;
    static "6LOWPAN": number;
    static WIREGUARD: number;
    static WIFI_P2P: number;
    static VRF: number;
}
...
export class SriovVFVlanProtocol {
    constructor(copy: SriovVFVlanProtocol);
    // Properties
    static "1Q": number;
    static "1AD": number;
}
...
export class SettingWirelessWakeOnWLan {
    constructor(copy: SettingWirelessWakeOnWLan);
    // Properties
    static ANY: number;
    static DISCONNECT: number;
    static MAGIC: number;
    static GTK_REKEY_FAILURE: number;
    static EAP_IDENTITY_REQUEST: number;
    static "4WAY_HANDSHAKE": number;
    static RFKILL_RELEASE: number;
    static TCP: number;
    static ALL: number;
...
export class Client extends GObject.Object implements Gio.AsyncInitable, Gio.Initable {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: 'active-connection-added', callback: (_source: this, active_connection: ActiveConnection) => void): number;
    connect_after(signal: 'active-connection-added', callback: (_source: this, active_connection: ActiveConnection) => void): number;
    emit(signal: 'active-connection-added', active_connection: ActiveConnection): void;
    connect(signal: 'active-connection-removed', callback: (_source: this, active_connection: ActiveConnection) => void): number;
    connect_after(signal: 'active-connection-removed', callback: (_source: this, active_connection: ActiveConnection) => void): number;
    ...
    connect_after(signal: 'connection-removed', callback: (_source: this, connection: RemoteConnection) => void): number;
...
export abstract class SecretAgentOld extends GObject.Object implements Gio.AsyncInitable, Gio.Initable {
...
export class VpnPluginInfo extends GObject.Object implements Gio.Initable {
    ...
    static list_add(list: GLib.SList, plugin_info: VpnPluginInfo): boolean;
    static list_find_by_filename(list: GLib.SList, filename: string): VpnPluginInfo;
    static list_find_by_name(list: GLib.SList, name: string): VpnPluginInfo;
    static list_find_by_service(list: GLib.SList, service: string): VpnPluginInfo;
    static list_find_service_type(list: GLib.SList, name: string): string;
    static list_get_service_types(list: GLib.SList, only_existing: boolean, with_abbreviations: boolean): string[];
    static list_load(): GLib.SList;
    static list_remove(list: GLib.SList, plugin_info: VpnPluginInfo): boolean;
...
export interface VpnEditor extends GObject.Object {
    // Members
...
export interface VpnEditorPlugin extends GObject.Object {
    // Properties
    description: string;
    name: string;
    service: string;
