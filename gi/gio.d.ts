...
export function async_initable_newv_async(object_type: GType, n_parameters: number, parameters: GObject.Parameter, io_priority: number, cancellable: Cancellable | null, callback: AsyncReadyCallback | null): void;
...
export function bus_own_name_on_connection(connection: DBusConnection, name: string, flags: BusNameOwnerFlags, name_acquired_closure: GObject.Closure | null, name_lost_closure: GObject.Closure | null): number;

export function bus_own_name(bus_type: BusType, name: string, flags: BusNameOwnerFlags, bus_acquired_closure: GObject.Closure | null, name_acquired_closure: GObject.Closure | null, name_lost_closure: GObject.Closure | null): number;

export function bus_unown_name(owner_id: number): void;

export function bus_unwatch_name(watcher_id: number): void;

export function bus_watch_name_on_connection(connection: DBusConnection, name: string, flags: BusNameWatcherFlags, name_appeared_closure: GObject.Closure | null, name_vanished_closure: GObject.Closure | null): number;

export function bus_watch_name(bus_type: BusType, name: string, flags: BusNameWatcherFlags, name_appeared_closure: GObject.Closure | null, name_vanished_closure: GObject.Closure | null): number;
...
export function initable_newv(object_type: GType, parameters: GObject.Parameter[], cancellable: Cancellable | null): GObject.Object;
...
export type AsyncReadyCallback = (source_object: GObject.Object | null, res: AsyncResult) => void;
...
export type DBusInterfaceGetPropertyFunc = (connection: DBusConnection, sender: string, object_path: string, interface_name: string, property_name: string, error: GLib.Error) => GLib.Variant;

export type DBusInterfaceMethodCallFunc = (connection: DBusConnection, sender: string, object_path: string, interface_name: string, method_name: string, parameters: GLib.Variant, invocation: DBusMethodInvocation) => void;

export type DBusInterfaceSetPropertyFunc = (connection: DBusConnection, sender: string, object_path: string, interface_name: string, property_name: string, value: GLib.Variant, error: GLib.Error) => boolean;

export type DBusMessageFilterFunction = (connection: DBusConnection, message: DBusMessage, incoming: boolean) => DBusMessage | null;

export type DBusProxyTypeFunc = (manager: DBusObjectManagerClient, object_path: string, interface_name: string | null) => GType;

export type DBusSignalCallback = (connection: DBusConnection, sender_name: string, object_path: string, interface_name: string, signal_name: string, parameters: GLib.Variant) => void;

export type DBusSubtreeDispatchFunc = (connection: DBusConnection, sender: string, object_path: string, interface_name: string, node: string, out_user_data: any) => DBusInterfaceVTable;

export type DBusSubtreeIntrospectFunc = (connection: DBusConnection, sender: string, object_path: string, node: string) => DBusInterfaceInfo;
...
export type FileMeasureProgressCallback = (reporting: boolean, current_size: number, num_dirs: number, num_files: number) => void;
...
export type PollableSourceFunc = (pollable_stream: GObject.Object) => boolean;
...
export type TaskThreadFunc = (task: Task, source_object: GObject.Object, task_data: any | null, cancellable: Cancellable | null) => void;
...
export class DBusError extends GLib.Error {
    ...
    // Members
    encode_gerror(error: GLib.Error): string;
    get_remote_error(error: GLib.Error): string;
    is_remote_error(error: GLib.Error): boolean;
    new_for_dbus_error(dbus_error_name: string, dbus_error_message: string): GLib.Error;
    quark(): GLib.Quark;
    register_error(error_domain: GLib.Quark, error_code: number, dbus_error_name: string): boolean;
    register_error_domain(error_domain_quark_name: string, quark_volatile: number, entries: DBusErrorEntry[]): void;
    set_dbus_error(error: GLib.Error, dbus_error_name: string, dbus_error_message: string, format: string | null, ___: any[]): void;
    set_dbus_error_valist(error: GLib.Error, dbus_error_name: string, dbus_error_message: string, format: string | null, var_args: any): void;
    strip_remote_error(error: GLib.Error): boolean;
    unregister_error(error_domain: GLib.Quark, error_code: number, dbus_error_name: string): boolean;
}
...
export class Application extends GObject.Object implements ActionGroup, ActionMap {
    ...
    connect_after(signal: 'open', callback: (_source: this, files: File[], n_files: number, hint: string) => void): number;
...
export class DesktopAppInfo extends GObject.Object implements AppInfo {
    ...
    vfunc_launch(files: GLib.List | null, context: AppLaunchContext | null): boolean;
    vfunc_launch_uris(uris: GLib.List | null, context: AppLaunchContext | null): boolean;
    vfunc_launch_uris_async(uris: GLib.List | null, context: AppLaunchContext | null, cancellable: Cancellable | null, callback: AsyncReadyCallback | null): void;
...
export class IOModule extends GObject.TypeModule implements GObject.TypePlugin {
    ...
    static query(): string[];
    // Implemented Members
    complete_interface_info(instance_type: GType, interface_type: GType, info: GObject.InterfaceInfo): void;
    complete_type_info(g_type: GType, info: GObject.TypeInfo, value_table: GObject.TypeValueTable): void;
    unuse(): void;
    use(): void;
...
export abstract class MenuModel extends GObject.Object {
    ...
    vfunc_get_item_attributes(item_index: number): GLib.HashTable;
    vfunc_get_item_link(item_index: number, link: string): this;
    vfunc_get_item_links(item_index: number): GLib.HashTable;
    vfunc_get_n_items(): number;
...
export abstract class Resolver extends GObject.Object {
    ...
    vfunc_lookup_by_name_with_flags(hostname: string, flags: ResolverNameLookupFlags, cancellable: Cancellable | null): GLib.List;
    ...
    vfunc_lookup_by_name_with_flags_finish(result: AsyncResult): GLib.List;
...
export class Settings extends GObject.Object {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: 'change-event', callback: (_source: this, keys: GLib.Quark[] | null, n_keys: number) => boolean): number;
    connect_after(signal: 'change-event', callback: (_source: this, keys: GLib.Quark[] | null, n_keys: number) => boolean): number;
...
export class ThreadedSocketService extends SocketService {
    ...
    connect_after(id: string, callback: (...args: any[]) => any): number;
    emit(id: string, ...args: any[]): void;
    connect(signal: 'run', callback: (_source: this, connection: SocketConnection, source_object: GObject.Object) => boolean): number;
    connect_after(signal: 'run', callback: (_source: this, connection: SocketConnection, source_object: GObject.Object) => boolean): number;
    emit(signal: 'run', connection: SocketConnection, source_object: GObject.Object): void;
    // Constructors
...
export class Vfs extends GObject.Object {
    ...
    vfunc_local_file_add_info(filename: string, device: number, attribute_matcher: FileAttributeMatcher, info: FileInfo, cancellable: Cancellable | null, extra_data: any | null, free_extra_data: GLib.DestroyNotify): void;
...
export class NativeSocketAddress {
    constructor(copy: NativeSocketAddress);
}
...
export interface AppInfoNamespace {
    ...
    launch_default_for_uri_async(uri: string, context: AppLaunchContext | null, cancellable: Cancellable | null, callback: AsyncReadyCallback | null): void;
...
export interface File extends GObject.Object {
    ...
    vfunc_get_child_for_display_name(display_name: string): this;
    ...
    vfunc_resolve_relative_path(relative_path: string): this;
    ...
    vfunc_set_display_name(display_name: string, cancellable: Cancellable | null): this;
    ...
    vfunc_set_display_name_finish(res: AsyncResult): this;
