...
function fade_in() {
  ...
  if (
    ...
    (Settings.window_settings_manager["enable_background_tweaks"][
      custom.app_info
    ] ||
      Settings.app_settings_manager["enable_background_tweaks"][
        custom.app_info
      ])
  ) {
  ...
  if (!Settings.get_hide_corners()) {
    ...
    let unmaximized = !this.status.is_transparent()
      ? maximized
...
function fade_out() {
  ...
  if (!Settings.get_hide_corners()) {
    ...
    let maximized = this.status.is_transparent()
      ? unmaximized
      : Settings.get_maximized_opacity();
